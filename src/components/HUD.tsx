...
export const HUD: React.FC<HUDProps> = ({ score, life, level, progress }) => {
  return (
    <div className="flex items-center justify-between gap-12 p-4 bg-black text-white border-b-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-6 rounded-xl w-full" id="game-hud">
